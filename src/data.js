...
export const ZODIACS = [
  { id: 'aries', label: '牡羊座', god: '阿瑞斯 Ares', element: 'fire', desc: '星圖中奮力奔騰的黃金公羊，具備無畏的開創性與純粹的行動意志。' },
  { id: 'taurus', label: '金牛座', god: '狄蜜特 Demeter', element: 'earth', desc: '破雲而出的雄渾野牛，靈魂深處錨定著對物質與美感的極高鑑賞力。' },
  { id: 'gemini', label: '雙子座', god: '荷米斯 Hermes', element: 'air', desc: '星圖中親密依偎的孿生子，思維在兩個維度間自由切換，熱愛資訊。' },
  { id: 'cancer', label: '巨蟹座', god: '塞勒涅 Selene', element: 'water', desc: '具備堅固冷靜的外殼，內裡卻包裹著如同海洋潮汐般細膩的直覺。' },
  { id: 'leo', label: '獅子座', god: '阿波羅 Apollo', element: 'fire', desc: '步伐昂首的傲慢雄獅，天生需要成為空間的核心座標，看重尊嚴。' },
  { id: 'virgo', label: '處女座', god: '阿斯特莉亞 Astraea', element: 'earth', desc: '手持麥穗、展翅佇立的女神，用極致的理性在凡間梳理出優雅秩序。' },
  { id: 'libra', label: '天秤座', god: '阿芙蘿黛蒂 Aphrodite', element: 'air', desc: '懸浮於星空中央的黃金天秤，終生在人際、美感間尋求最不費力的平衡。' },
  { id: 'scorpio', label: '天蠍座', god: '黑帝斯 Hades', element: 'water', desc: '帶著神祕引力的潛伏毒蠍，情感絕對純粹且帶有強烈的精神防禦。' },
  { id: 'sagittarius', label: '射手座', god: '宙斯 Zeus', element: 'fire', desc: '挽弓拉滿、蓄勢待發的半人馬戰士，靈魂永遠望向更高遠的冒險星空。' },
  { id: 'capricorn', label: '摩羯座', god: '克洛諾斯 Cronus', element: 'earth', desc: '古老神秘的海山羊，既能在陡峭山巔攀登，亦能在深邃海底泅泳。' },
  { id: 'aquarius', label: '水瓶座', god: '烏拉諾斯 Uranus', element: 'air', desc: '傾倒泉水的持甕智者，思想前衛叛逆，靈魂不屬於任何單一框架。' },
  { id: 'pisces', label: '雙魚座', god: '波賽頓 Poseidon', element: 'water', desc: '被絲帶相連、朝相反方向游動的雙魚，精神世界無垠且具備強大同理心。' },
]
...
// 💡 擴充至 25 道極具張力、像寫實塔羅牌面的深度話題資料庫
const MASTER_TAROT_BANK = [
  ...
  { id: 11, title: '如果你可以擁有一種神話中的超能力，你最希望是哪一個？打算怎麼用它？', rate: 85, reason: '用天馬行空的思想實驗放鬆大腦大皮質，非常適合打破因物理環境狹窄或嘈雜帶來的壓迫感。' },
  ...
  { id: 14, title: '如果你的靈魂可以用一種古典樂器來形容，你覺得那會是什麼聲音？', rate: 87, reason: '極具 Athens 藝術感官的抽象隱喻題，能引導重視內在精神層次（如 INFJ/INFP）的對象展現深度思維。' },
  { id: 15, title: '探討一個你小時候深信不疑，但長大後發現完全是大人騙局的童年秘密', rate: 91, reason: '喚醒童年的純真與荒謬記憶，能瞬間在潛意識裡建立起宛如多年老友般的深層熟悉感。' },
  { id: 16, title: '分享一本對你的價值觀產生過顛覆性影響的書籍或電影，它改寫了你什麼看法？', rate: 94, reason: '這是高階知性對頻的終極試金石，能讓你們在短時間內觸及彼此的思想核心與靈魂邊界。' },
...
export function generateComprehensiveAnalysis({ zodiac, mbti, purpose, environment, energy, screenshotScores }) {
  ...
  if (energy === 'high') {
    ...
    macroAssessment += ` 值得注意的是，今日他們的靈魂更傾向於一種靜謐、溫和且卸下防備的低能量沉澱，過於喧鬧的開場可能會讓他們悄悄築起防禦牆。`;
  }

  // 💡 隨機從 20+ 的牌組庫中抽取符合當前相性的 5 張大尺寸塔羅牌
  const shuffled = [...MASTER_TAROT_BANK].sort(() => 0.5 - Math.random());
